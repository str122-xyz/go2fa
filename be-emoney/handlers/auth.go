...
func NewAuthHandler(db *gorm.DB, firebaseApp *firebase.App, jwtSvc *services.JWTService) *AuthHandler {
	return &AuthHandler{db: db, firebaseApp: firebaseApp, jwtSvc: jwtSvc}
}
